...
\title{Video-based dynamic mesh coding test model v1.0 user manual}
\author{%
	Julien Ricard
	\email{julien.ricard@interdital.com}
}
\mpegdocpurpose{User manual}
\mpegmeeting{July 2022, Online }
\mpegdocnum{nXXXXX}
\mpegdocstatus{Draft}
...
for the V-DMC project. It applies to version 1.0 of the software.
\end{abstract}
