...
\title{Video-based dynamic mesh coding test model v0 user manual}
\author{%
	David Flynn
	\email{davidflynn@apple.com}
}

\mpegmeeting{Online -- April 2022}
\mpegdocnum{nXXXXX}
\mpegdocstatus{Draft}
\mpegdocsource{WG7}
...
for the V-DMC project. It applies to version 0.0 of the software.
\end{abstract}
...
\input{README.options.gengof.tex}
\input{README.options.simplify.tex}
\input{README.options.uvatlas.tex}
\input{README.options.fitsubdiv.tex}
\input{README.options.vmc.tex}
